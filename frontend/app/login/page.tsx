...
export default function LoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_20%_15%,rgba(6,144,97,0.10),transparent_28%),radial-gradient(circle_at_80%_0%,rgba(0,130,208,0.10),transparent_24%),linear-gradient(180deg,#ffffff,#f6f6f4)] p-4">
